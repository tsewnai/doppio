...
export const Route = createFileRoute("/_authed/french-press/")({
  loader: () => listBrews({ data: "french_press" }),
  component: FrenchPressPage,
});

function FrenchPressPage() {
    ...
    <div>
      ...
      {brews.length === 0 ? (
        <div className="px-4 py-16 text-center">
          ...
          <p className="font-medium">No French Press brews yet</p>
          <p className="text-sm text-muted-foreground mt-1 mb-6">
            Track your immersion brews
          </p>
          <Link to="/french-press/new">
            <Button>Log your first French Press</Button>
          </Link>
        </div>
      ) : (
